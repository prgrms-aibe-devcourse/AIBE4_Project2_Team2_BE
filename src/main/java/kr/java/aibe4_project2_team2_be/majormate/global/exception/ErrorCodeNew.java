...
public enum ErrorCodeNew {
	...
	AUTH_401_REFRESH_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH_401_REFRESH_TOKEN_NOT_FOUND",
		"리프레시 토큰을 찾을 수 없습니다."),
	...
	AUTH_400_OAUTH2_EMAIL_NOT_FOUND(HttpStatus.BAD_REQUEST, "AUTH_400_OAUTH2_EMAIL_NOT_FOUND",
		"OAuth2 제공자로부터 이메일을 받을 수 없습니다."),
	AUTH_400_OAUTH2_PROVIDER_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "AUTH_400_OAUTH2_PROVIDER_NOT_SUPPORTED",
		"지원하지 않는 OAuth2 제공자입니다."),
	AUTH_400_VERIFICATION_CODE_NOT_FOUND(HttpStatus.BAD_REQUEST, "AUTH_400_VERIFICATION_CODE_NOT_FOUND",
		"인증 코드를 찾을 수 없습니다."),
	AUTH_400_VERIFICATION_CODE_EXPIRED(HttpStatus.BAD_REQUEST, "AUTH_400_VERIFICATION_CODE_EXPIRED", "인증 코드가 만료되었습니다."),
	AUTH_400_INVALID_VERIFICATION_CODE(HttpStatus.BAD_REQUEST, "AUTH_400_INVALID_VERIFICATION_CODE",
		"인증 코드가 일치하지 않습니다."),
	...
	MEMBER_400_PROFILE_IMAGE_FILE_REQUIRED(
		HttpStatus.BAD_REQUEST, "MEMBER_400_PROFILE_IMAGE_FILE_REQUIRED", "프로필 이미지 파일은 필수다."
	),
